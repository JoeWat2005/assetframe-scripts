...
# The leaf HTML section builders live in payload_sections.py now; re-exported so build_pro
# (which calls them) is unchanged.
from payload_sections import (  # noqa: F401
    _scenario_matrix_html, _events_html, _technicals_html, _setups_html,
    _scorecard_html, _ledger_html, _source_audit_html,
)
